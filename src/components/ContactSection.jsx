...
export default function ContactSection() {
  ...
  const safePhone = (BUSINESS.phone ?? '').trim()
      ...
      <div className="max-w-[1800px] mx-auto px-fluid-sm">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          <div>
            ...
            <h2 className="mt-3 text-3xl md:text-5xl font-black tracking-tight">Wpadnij na Wąwozową</h2>
          </div>
        ...
        <div className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <div className="grid gap-5">
                ...
                {safePhone && (
                  <div>
                    ...
                    <a
                      href={phoneHref}
                      className="mt-2 inline-flex items-center font-black text-xl hover:text-accent-cyan transition-colors"
                    >
                      {safePhone}
                    </a>
                  </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-black/20 overflow-hidden min-h-[360px]">
            <iframe
              ...
              src="https://www.google.com/maps?q=W%C4%85wozowa%2036%2F65%20Warszawa&output=embed"
            />
          </div>
        </div>
      </div>
